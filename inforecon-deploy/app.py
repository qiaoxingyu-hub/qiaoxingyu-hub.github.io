...
from analyst import analyze as ai_analyze
from analyst import analyze as ai_analyze
...
async def analyze_prediction(category:str=Form(...),subject:str=Form(...),direction:str=Form(...),timeframe:str=Form('3m')):
    result = ai_analyze(subject, direction, timeframe, category)
    return result
...
if __name__ == "__main__":
    print("="*50)
    print("  InfoRecon v2 - http://localhost:8899")
    print("="*50)
